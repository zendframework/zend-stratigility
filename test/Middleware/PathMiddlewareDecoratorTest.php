...
class PathMiddlewareDecoratorTest extends TestCase
{
    ...
    public function nestedPathCombinations()
    {
        return [
            ...
            'empty-bare-taildot'         => ['',       'foo',    '/foo.bar',      true],
            ...
            'empty-tail-taildot'         => ['',       'foo/',   '/foo.bar',      true],
            ...
            'empty-prefix-taildot'       => ['',       '/foo',   '/foo.bar',      true],
            ...
            'empty-surround-taildot'     => ['',       '/foo/',  '/foo.bar',      true],
            ...
            'root-bare-taildot'          => ['/',      'foo',    '/foo.bar',      true],
            ...
            'root-tail-taildot'          => ['/',      'foo/',   '/foo.bar',      true],
            ...
            'root-prefix-taildot'        => ['/',      '/foo',   '/foo.bar',      true],
            ...
            'root-surround-taildot'      => ['/',      '/foo/',  '/foo.bar',      true],
            ...
            'bare-bare-taildots'         => ['foo',    'bar',    '/foo.bar.baz',  false], // @todo: is it valid?
            'bare-bare-taildot'          => ['foo',    'bar',    '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'bare-tail-taildots'         => ['foo',    'bar/',   '/foo.bar.baz',  false], // @todo: is it valid?
            'bare-tail-taildot'          => ['foo',    'bar/',   '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'bare-prefix-taildots'       => ['foo',    '/bar',   '/foo.bar.baz',  false], // @todo: is it valid?
            'bare-prefix-taildot'        => ['foo',    '/bar',   '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'bare-surround-taildots'     => ['foo',    '/bar/',  '/foo.bar.baz',  false], // @todo: is it valid?
            'bare-surround-taildot'      => ['foo',    '/bar/',  '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'tail-bare-taildots'         => ['foo/',   'bar',    '/foo.bar.baz',  false], // @todo: is it valid?
            'tail-bare-taildot'          => ['foo/',   'bar',    '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'tail-tail-taildots'         => ['foo/',   'bar/',   '/foo.bar.baz',  false], // @todo: is it valid?
            'tail-tail-taildot'          => ['foo/',   'bar/',   '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'tail-prefix-taildots'       => ['foo/',   '/bar',   '/foo.bar.baz',  false], // @todo: is it valid?
            'tail-prefix-taildot'        => ['foo/',   '/bar',   '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'tail-surround-taildots'     => ['foo/',   '/bar/',  '/foo.bar.baz',  false], // @todo: is it valid?
            'tail-surround-taildot'      => ['foo/',   '/bar/',  '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'prefix-bare-taildots'       => ['/foo',   'bar',    '/foo.bar.baz',  false], // @todo: is it valid?
            'prefix-bare-taildot'        => ['/foo',   'bar',    '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'prefix-tail-taildots'       => ['/foo',   'bar/',   '/foo.bar.baz',  false], // @todo: is it valid?
            'prefix-tail-taildot'        => ['/foo',   'bar/',   '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'prefix-prefix-taildots'     => ['/foo',   '/bar',   '/foo.bar.baz',  false], // @todo: is it valid?
            'prefix-prefix-taildot'      => ['/foo',   '/bar',   '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'prefix-surround-taildots'   => ['/foo',   '/bar/',  '/foo.bar.baz',  false], // @todo: is it valid?
            'prefix-surround-taildot'    => ['/foo',   '/bar/',  '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'surround-bare-taildots'     => ['/foo/',  'bar',    '/foo.bar.baz',  false], // @todo: is it valid?
            'surround-bare-taildot'      => ['/foo/',  'bar',    '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'surround-tail-taildots'     => ['/foo/',  'bar/',   '/foo.bar.baz',  false], // @todo: is it valid?
            'surround-tail-taildot'      => ['/foo/',  'bar/',   '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'surround-prefix-taildots'   => ['/foo/',  '/bar',   '/foo.bar.baz',  false], // @todo: is it valid?
            'surround-prefix-taildot'    => ['/foo/',  '/bar',   '/foo/bar.baz',  true],  // @todo: is it valid?
            ...
            'surround-surround-taildots' => ['/foo/',  '/bar/',  '/foo.bar.baz',  false], // @todo: is it valid?
            'surround-surround-taildot'  => ['/foo/',  '/bar/',  '/foo/bar.baz',  true],  // @todo: is it valid?
        ];
    }
